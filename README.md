...
* Which **markets or regions perform better**
* How **customer sales performance changes year-over-year**
...
* **Year-wise sales comparison (2019, 2020, 2021)**
* **Year-over-Year growth analysis (2021 vs 2020)**
* **Conditional formatting to highlight high and low sales values**
* **Interactive filters for data exploration**

### Available Filters

The dashboard includes filters that allow users to dynamically analyze data by:
...
* **Customer-wise sales performance analysis**
* **Year-over-year revenue comparison**
* **Identification of high-value customers**
* **Sales trend evaluation across multiple years**
* **Growth analysis to identify expanding and declining customers**
...
* Some customers contribute **significantly higher revenue compared to others**.
* Sales have shown **strong year-over-year growth from 2020 to 2021**.
* Several customers experienced **rapid revenue expansion**, indicating potential high-value partnerships.
* Some customers show **lower sales performance**, which could require targeted sales strategies.
...
* **Detect declining customer performance early**
* **Increase sales efficiency**
* **Discover revenue growth opportunities**
* **Monitor sales trends for strategic planning**
